...
SAMPLES = [
    ...
    ("Code-switching",        "ar", "اليوم بتاريخ 15 كانون الثاني 2026، صحيت الساعة 7:35 الصبح وشفت رسالة جديدة بخصوص دفعة مالية لازم تنسدد قبل تاريخ 31/01/2026. كانت الرسالة بتقول إنو قيمة الفاتورة 245.75 دولار أمريكي، ففتحت الـ banking app وشفت إنو رصيدي حوالي 12,450.90 دولار، بينما كان عندي كمان 3,200 يورو بحساب تاني. حوالي الساعة 10:15 صار عندي online meeting مع فريق المشروع، وحكينا عن زيادة المبيعات بنسبة 18.5% خلال آخر 6 شهور، وعن خطة جديدة ممكن ترفع الإيرادات لـ 25% بنهاية السنة."),
